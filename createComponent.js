...
var htmlTpl = [];
htmlTpl.push('<div class="styleguide jinbao-widget-' + widget + '">');
htmlTpl.push('');
htmlTpl.push('</div>');
htmlTpl = htmlTpl.join('\n');

var styleTpl = [];
styleTpl.push('.jinbao-widget-' + widget + ' {');
styleTpl.push('');
styleTpl.push('}');
...
jsTpl.push("    name: 'jinbao-widget-" + widget + "-style',");
jsTpl.push("    content: style");
jsTpl.push("});");
jsTpl.push("");
jsTpl.push("export default Vue.component('" + componentName + "', {");
...
mkdirSync('widget/component/' + widget);

writeFile ('widget/component/'+ widget + '/' + widget + '.inline.less', styleTpl);
writeFile ('widget/component/'+ widget + '/' + widget + '.js', jsTpl);
writeFile ('widget/component/'+ widget + '/' + widget + '.tpl', htmlTpl);

		...
		'form' : {
			...
			'formlist' :[
				[ 	
					...
					{ name : '理财师归属地' , wrapperClass :'col-md-9 city-select' ,type : 'area'},
				],[
					...
					{ name : '下单时间', wrapperClass: 'col-md-3' ,type : 'time', classList: 'beginTime' },
					{ name : '到', wrapperClass: 'col-md-3' ,type : 'time', classList: 'endTime' }
